    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Travelcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  Travelcoind [options]                     " + "\n" +
                  "  Travelcoind [options] <command> [params]  " + _("Send command to -server or Travelcoind") + "\n" +
                  "  Travelcoind [options] help                " + _("List commands") + "\n" +
                  "  Travelcoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: Travelcoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 10118 or testnet: 10218)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 10116 or testnet: 10216)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Travelcoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Travelcoin is probably already running."), strDataDir.c_str()));
